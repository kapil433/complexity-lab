...
|---|---|---|---|
| Annual state population | Ministry of Health and Family Welfare population projections, then Census of India | The lab has rounded 2024 projections, but an official state-year extract and stable source file were not verified in this pass | Keep current data constrained; do not calculate historical per-capita rates |
...
|---|---|---|
| State auto-finance penetration | No defensible public state x year passenger-vehicle finance series covering banks, NBFCs, and captive financiers was found | Regulatory or industry microdata with vehicle-loan purpose, state, period, lender coverage, and denominator |
...
1. Replace the fixed-2024 population denominator with an official annual
   state-population series.
